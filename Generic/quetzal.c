...
zword restore_quetzal (FILE *svf, FILE *stf, long stf_start_pos)
{
	...
	switch (tmpl)
	{
		...
		{
		    (void) fseek (stf, stf_start_pos, SEEK_SET);
...
zword save_quetzal (FILE *svf, FILE *stf, long stf_start_pos)
{
